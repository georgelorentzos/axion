...
export default function ChannelList() {
    ...
    return (
        <div onContextMenu={handleContextMenu} className="w-[370px] h-screen border-r border-outline flex flex-col">
            <audio preload="auto" />
            ...
            <div className="relative space-y-3 p-6 flex flex-col flex-1">
                ...
                <ActionMenu isActionMenuOpen={isActionMenuOpen} onClose={() => setIsActionMenuOpen(false)} position={pos} createChannelBtn />
            </div>
