    ...
    return (
        <div className="bg-[#141414] h-screen w-full flex flex-col justify-center items-center">
            ...
            <div className="text-white text-[30px]">Continue</div>
                ...
                <input 
                type="email" 
                className="transition duration-200 focus:outline-none pl-4 text-[#98968e] bg-field h-[3rem] w-[21rem] rounded-xl" 
                ...
                <div className="flex flex-col gap-2">
                    <button 
                    className="transition duration-200 bg-green hover:bg-greenhover text-white h-[3rem] w-[21rem] rounded-xl cursor-pointer"
                    onClick={handleLogin}
                    disabled={loading}
